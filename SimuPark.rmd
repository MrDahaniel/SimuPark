...
knitr::kable(cbind(attractions, service_rates, duration, reported_wait_times, popularity))
```
...
Para el desarrollo del prototipo para la simulación, esta se 
...
- https://touringplans.com/animal-kingdom/attractions/duration#